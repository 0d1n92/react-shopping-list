  ...
  return (
    <AppBar position="static">
      <Toolbar>
        ...
        <ToolBarInput onChange={onChangeAddItem} placeholder={'Add item'}></ToolBarInput>
        <Button
          onClick={() => {
            props.onAdd(enteredItem);
          }}
        >
          Add
        </Button>
        <ToolBarInput onChange={props.onSearch} placeholder={'Search'}></ToolBarInput>
